...
public class Constants {
	...
	public static final int BACK_PRESSURE_HIGH_WATERMARK = Integer.parseInt(System.getProperty("raknetserver.backPressureHighWatermark", "512"));
	public static final int BACK_PRESSURE_LOW_WATERMARK = Integer.parseInt(System.getProperty("raknetserver.backPressureLowWatermark", "256"));
	public static final int MAX_PENDING_FRAME_SETS = Integer.parseInt(System.getProperty("raknetserver.maxPendingFrameSets", "128"));
