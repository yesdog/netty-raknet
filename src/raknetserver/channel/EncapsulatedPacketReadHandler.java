...
public class EncapsulatedPacketReadHandler extends SimpleChannelInboundHandler<Collection<EncapsulatedPacket>> {

	@Override
	protected void channelRead0(ChannelHandlerContext ctx, Collection<EncapsulatedPacket> epackets) throws Exception {
		...
		//fire read for packet buffer
		for (EncapsulatedPacket fepacket : fullEPackets) {
			ctx.fireChannelRead(fepacket.getData());
		}
	}
